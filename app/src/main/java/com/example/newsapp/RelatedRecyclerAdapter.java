...
public class RelatedRecyclerAdapter extends RecyclerView.Adapter<RelatedRecyclerAdapter.NewAdapterHolder> {

    private List<News> newsList;
    private Context context;
    private OnRowClickListener listener;

    public RelatedRecyclerAdapter(List<News> newsList, Context context, OnRowClickListener clickListener) {
    ...
    @NonNull
    @Override
    public RelatedRecyclerAdapter.NewAdapterHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.property_relate, parent, false);
        return new NewAdapterHolder(itemView, listener);
    }

    @Override
    public void onBindViewHolder(@NonNull RelatedRecyclerAdapter.NewAdapterHolder holder, int position) {
